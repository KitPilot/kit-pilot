...
import {
	kitpilotCliCommandNames,
	type KitPilotCliCommandName,
	type KitPilotCliInputCommand,
	type KitPilotCliStartCommand,
...
export type StdinStreamCommandName = KitPilotCliCommandName

export type StdinStreamCommand = KitPilotCliInputCommand

// ---------------------------------------------------------------------------
// Parsing
// ---------------------------------------------------------------------------

export const VALID_STDIN_COMMANDS = new Set<StdinStreamCommandName>(kitpilotCliCommandNames)
		...
		if (command === "start") {
			...
			if (isRecord(parsed.configuration)) {
				return {
					...
					configuration: parsed.configuration as KitPilotCliStartCommand["configuration"],
				}
			}
