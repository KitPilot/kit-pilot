...
program
	.name("kitpilot")
	.description("KitPilot CLI - starts an interactive session by default, use -p/--print for non-interactive output")
	.version(VERSION)
...
program
	.command("upgrade")
	.description("Upgrade KitPilot CLI to the latest version")
	.action(async () => {
