...
import type { ExtensionMessage, WebviewMessage, ClineAskResponse, ClineMessage, ClineAsk } from "@kit-pilot/types"
...
/**
 * ExtensionClient is the main interface for interacting with the KitPilot extension.
 *
 * Basic usage:
 * ```typescript
