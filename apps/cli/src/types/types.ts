import type { ProviderName, ReasoningEffortExtended } from "@kit-pilot/types"
import type { OutputFormat } from "./json-events.js"

// vscode-lm-only build: CLI is not the target for this build, but its
// supportedProviders list is narrowed to match the slimmed ProviderName.
export const supportedProviders = ["vscode-lm"] as const satisfies ProviderName[]
