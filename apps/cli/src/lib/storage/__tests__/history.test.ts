...
describe("historyStorage", () => {
	...
	describe("getHistoryFilePath", () => {
		it("should return the correct path to cli-history.json", () => {
			...
			expect(result).toBe(path.join("/home/testuser", ".kitpilot", "cli-history.json"))
		})
	})
	...
	describe("saveHistory", () => {
		it("should create directory and save history", async () => {
			...
			expect(fs.mkdir).toHaveBeenCalledWith(path.join("/home/testuser", ".kitpilot"), { recursive: true })
