import { readTaskSessionsFromStoragePath } from "@kit-pilot/core/cli"
...
vi.mock("@kit-pilot/core/cli", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@kit-pilot/core/cli")>()
	return {
		...actual,
