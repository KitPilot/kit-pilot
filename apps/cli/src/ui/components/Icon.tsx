 ...
 *
 * Users can override this with the KITPILOT_NERD_FONT environment variable:
 * - KITPILOT_NERD_FONT=0 to force ASCII fallbacks (if icons don't render correctly)
 * - KITPILOT_NERD_FONT=1 to force Nerd Font icons
 *
...
function detectNerdFontSupport(): boolean {
	...
	const envOverride = process.env.KITPILOT_NERD_FONT
	...
	// and users can set KITPILOT_NERD_FONT=0 if needed
	return true
}
