...
import type { ExtensionMessage, ClineMessage, ClineAsk, ClineSay, TodoItem } from "@kit-pilot/types"
import { consolidateTokenUsage, consolidateApiRequests, consolidateCommands } from "@kit-pilot/core/cli"
