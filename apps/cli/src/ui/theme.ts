/**
 * Theme configuration for KitPilot CLI TUI
...
export const kitpilotHeader = hardcore.yellow // Yellow for kitpilot
...
export const kitpilotText = hardcore.text // Standard text for kitpilot
