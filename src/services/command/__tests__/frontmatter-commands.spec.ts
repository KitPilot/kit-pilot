...
vi.mock("../kitpilot-config", () => ({
	getGlobalKitPilotDirectory: vi.fn(() => "/mock/global/.kitpilot"),
	getProjectKitPilotDirectoryForCwd: vi.fn(() => "/mock/project/.kitpilot"),
}))
...
\`\`\``
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".kitpilot", "commands", "setup.md"),
				description: "Sets up the development environment",
...
Global setup instructions.`
			...
			expect(result).toEqual({
				...
				source: "global",
				filePath: expect.stringContaining(path.join(".kitpilot", "commands", "setup.md")),
				description: "Global setup command",
				argumentHint: undefined,
				mode: undefined,
			})
	...
	describe("argument-hint functionality", () => {
		it("should load command with argument-hint from frontmatter", async () => {
			const commandContent = `---
description: Create a new release of the KitPilot extension
...
Create a new release.`
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".kitpilot", "commands", "release.md"),
				description: "Create a new release of the KitPilot extension",
...
Deploy the application.`
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".kitpilot", "commands", "deploy.md"),
				description: "Deploy application to environment",
...
Start debugging.`
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".kitpilot", "commands", "debug-app.md"),
				description: "Debug the application",
				argumentHint: undefined,
				mode: "debug",
			})
