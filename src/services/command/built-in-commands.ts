...
<initialization>
  ...
  <todo_list_creation>
    ...
    1. Check for existing AGENTS.md files
       ...
       - .kitpilot/rules-code/AGENTS.md (relative to project root)
       - .kitpilot/rules-debug/AGENTS.md (relative to project root)
       - .kitpilot/rules-ask/AGENTS.md (relative to project root)
       - .kitpilot/rules-architect/AGENTS.md (relative to project root)
    ...
    8. Compile/Update AGENTS.md files
       ...
       - Create mode-specific files in .kitpilot/rules-*/ directories (IN PROJECT ROOT)
...
<analysis_workflow>
  ...
  1. **Discovery Phase**:
     ...
     IMPORTANT: The .kitpilot folder should be created in the PROJECT ROOT, not system root!
...
<output_structure>
  ...
  <mode_specific_files>
    ...
    - .kitpilot/rules-code/AGENTS.md (create .kitpilot in project root, not system root!)
    - .kitpilot/rules-debug/AGENTS.md (relative to project root)
    - .kitpilot/rules-ask/AGENTS.md (relative to project root)
    - .kitpilot/rules-architect/AGENTS.md (relative to project root)
    
    IMPORTANT: The .kitpilot directory must be created in the current project/workspace root directory,
    ...
    ├── .kitpilot/                        # IN PROJECT ROOT, NOT SYSTEM ROOT!
    │   ├── rules-code/
    ...
    .kitpilot/rules-code/AGENTS.md - ONLY non-obvious coding rules discovered by reading files:
    ...
    .kitpilot/rules-debug/AGENTS.md - ONLY non-obvious debugging discoveries:
    ...
    .kitpilot/rules-ask/AGENTS.md - ONLY non-obvious documentation context:
    ...
    .kitpilot/rules-architect/AGENTS.md - ONLY non-obvious architectural constraints:
