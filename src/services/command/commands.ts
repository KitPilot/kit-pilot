...
import { getGlobalKitPilotDirectory, getProjectKitPilotDirectoryForCwd } from "../kitpilot-config"
...
export async function getCommands(cwd: string): Promise<Command[]> {
	...
	const globalDir = path.join(getGlobalKitPilotDirectory(), "commands")
	...
	const projectDir = path.join(getProjectKitPilotDirectoryForCwd(cwd), "commands")
