...
export async function regexSearchFiles(
	...
	// Filter results using KitPilotIgnoreController if provided
	const filteredResults = kitpilotIgnoreController
		? results.filter((result) => kitpilotIgnoreController.validateAccess(result.file))
		: results
