...
export class FileWatcher implements IFileWatcher {
	...
	private ignoreController: KitPilotIgnoreController
	...
	constructor(
		...
		this.ignoreController = ignoreController || new KitPilotIgnoreController(workspacePath)
		if (ignoreInstance) {
		...
		try {
			...
			if (
				...
				return {
					path: filePath,
					status: "skipped" as const,
					reason: "File is ignored by .kitpilotignore or .gitignore",
				}
			}
