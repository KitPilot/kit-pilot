...
export class DirectoryScanner implements IDirectoryScanner {
	 ...
	 * @param kitpilotIgnoreController Optional KitPilotIgnoreController instance for filtering
	...
	public async scanDirectory(
		...
		// Initialize KitPilotIgnoreController if not provided
		const ignoreController = new KitPilotIgnoreController(directoryPath)

		await ignoreController.initialize()

		// Filter paths using .kitpilotignore
