...
// vscode-lm-only build: dynamic/router providers were removed. GetModelsOptions
// is kept as a permissive shape because a few call sites still construct it
// (their handlers no-op via the modelCache stub).
