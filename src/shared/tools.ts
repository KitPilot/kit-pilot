...
import type { ClineAsk, ToolProgressStatus, ToolGroup, ToolName, GenerateImageParams } from "@kit-pilot/types"
...
export const TOOL_DISPLAY_NAMES: Record<ToolName, string> = {
	...
	remember_this: "save persistent memory",
	forget_this: "delete persistent memory",
} as const
