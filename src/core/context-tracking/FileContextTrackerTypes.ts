...
export const recordSourceSchema = z.enum(["read_tool", "user_edited", "kitpilot_edited", "file_mentioned"])
...
export const fileMetadataEntrySchema = z.object({
	...
	kitpilot_read_date: z.number().nullable(),
	kitpilot_edit_date: z.number().nullable(),
