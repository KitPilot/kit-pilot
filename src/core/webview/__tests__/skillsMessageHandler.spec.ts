...
import type { SkillMetadata, WebviewMessage } from "@kit-pilot/types"
...
describe("skillsMessageHandler", () => {
	...
	const mockSkills: SkillMetadata[] = [
		...
		},
		{
			...
			path: "/project/.kitpilot/skills/project-skill/SKILL.md",
			source: "project",
			mode: "code",
		},
	]
	...
	describe("handleOpenSkillFile", () => {
		...
		it("opens a skill file with mode restriction", async () => {
			...
			expect(openFile).toHaveBeenCalledWith("/project/.kitpilot/skills/project-skill/SKILL.md")
		})
