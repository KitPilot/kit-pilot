	...
	implements vscode.WebviewViewProvider, TaskProviderLike
{
	...
	public readonly latestAnnouncementId = "kit-pilot-0.1.0-welcome" // Initial KitPilot welcome announcement.
	...
	*/
	...
	> {
		...
		// vscode-lm-only build: default to vscode-lm when no valid provider is set.
