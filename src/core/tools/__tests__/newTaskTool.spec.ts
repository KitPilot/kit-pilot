...
describe("newTaskTool", () => {
	...
	describe("VSCode setting: newTaskRequireTodos", () => {
		...
		it("should check VSCode setting with Package.name configuration key", async () => {
			...
			expect(mockGetConfiguration).toHaveBeenCalledWith("kit-pilot")
			expect(mockGet).toHaveBeenCalledWith("newTaskRequireTodos", false)
		})

		it("should use current Package.name value (kit-pilot-nightly) when accessing VSCode configuration", async () => {
			...
			;(pkg.Package as any).name = "kit-pilot-nightly"
			...
			expect(mockGetConfiguration).toHaveBeenCalledWith("kit-pilot-nightly")
			expect(mockGet).toHaveBeenCalledWith("newTaskRequireTodos", false)
		})
	})
