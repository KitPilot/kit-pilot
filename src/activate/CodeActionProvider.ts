...
import { CodeActionName, CodeActionId } from "@kit-pilot/types"
...
export const TITLES: Record<CodeActionName, string> = {
	EXPLAIN: "Explain with KitPilot",
	FIX: "Fix with KitPilot",
	IMPROVE: "Improve with KitPilot",
	ADD_TO_CONTEXT: "Add to KitPilot",
	NEW_TASK: "New KitPilot Task",
} as const
