 ...
 *
 * This writes logs to ~/.kitpilot/cli-debug.log, avoiding stdout/stderr
 * which would break TUI applications. The log format is timestamped JSON.
 *
 * Usage:
 *   import { debugLog, DebugLogger } from "@kit-pilot/core/cli"
 *
 *   // Simple logging
...
const DEBUG_LOG_PATH = path.join(os.homedir(), ".kitpilot", "cli-debug.log")
 ...
 * Writes timestamped entries to ~/.kitpilot/cli-debug.log
