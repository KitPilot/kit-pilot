...
This package provides IPC functionality for KitPilot, allowing external applications to communicate with the extension through a socket-based interface.
...
- `configuration`: KitPilot settings object
...
```typescript
import { IpcClient } from "@kit-pilot/ipc"
...
- Unix/Linux/macOS: `/tmp/kit-pilot-{id}.sock`
- Windows: `\\.\pipe\kit-pilot-{id}`
