...
import type { KitPilotEvents } from "./events.js"
...
export type KitPilotAPIEvents = KitPilotEvents

export interface KitPilotAPI extends EventEmitter<KitPilotAPIEvents> {
	/**
	 ...
	 * @returns The current configuration.
	 */
	getConfiguration(): KitPilotSettings
	/**
	 * Sets the configuration for the current task.
	 * @param values An object containing key-value pairs to set.
	 */
	setConfiguration(values: KitPilotSettings): Promise<void>
	/**
...
export interface KitPilotIpcServer extends EventEmitter<IpcServerEvents> {
	listen(): void
