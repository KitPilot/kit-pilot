...
// vscode-lm-only build: router providers were removed. RouterModels is kept
// as a permissive record so webview hooks that index it don't break.
export type RouterModels = Record<string, ModelRecord>
