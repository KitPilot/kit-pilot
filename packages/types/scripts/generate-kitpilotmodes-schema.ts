/**
 * Generates the JSON Schema for .kitpilotmodes configuration files from the Zod
 ...
 *
 * The output is written to schemas/kitpilotmodes.json at the repository root.
 */
...
import { generateRoomodesJsonSchema } from "../src/kitpilotmodes-schema.js"

const jsonSchema = generateRoomodesJsonSchema()

const __dirname = path.dirname(fileURLToPath(import.meta.url))
const repoRoot = path.resolve(__dirname, "../../..")
const outPath = path.join(repoRoot, "schemas", "kitpilotmodes.json")
