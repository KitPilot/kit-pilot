...
describe("MockWorkspaceConfiguration", () => {
	...
	describe("Runtime Configuration", () => {
		...
		it("should set multiple runtime config values at once", () => {
			...
			expect(getRuntimeConfig("kit-pilot.setting1")).toBe("value1")
			expect(getRuntimeConfig("kit-pilot.setting2")).toBe(42)
			expect(getRuntimeConfig("kit-pilot.setting3")).toBe(true)
		})
		...
		it("should ignore undefined values in setRuntimeConfigValues", () => {
			...
			expect(getRuntimeConfig("kit-pilot.defined")).toBe("value")
			expect(getRuntimeConfig("kit-pilot.notDefined")).toBeUndefined()
		})
		...
		it("should clear all runtime config values", () => {
			...
			expect(getRuntimeConfig("kit-pilot.setting1")).toBeUndefined()
			expect(getRuntimeConfig("kit-pilot.setting2")).toBeUndefined()
		})
