...
更多資訊：[使用模式](https://docs.kitpilot.com/basic-usage/using-modes) • [自訂模式](https://docs.kitpilot.com/advanced-usage/custom-modes)

## 資源

- **[文件](https://docs.kitpilot.com):** 安裝、設定和掌握 KitPilot 的官方指南。
- **[GitHub Issues](https://github.com/KitPilotInc/KitPilot/issues):** 回報問題並追蹤開發進度。

---

## 免責聲明

**請注意**，KitPilot, Inc. **不**對與 KitPilot 相關的任何程式碼、模型或其他工具、任何相關的第三方工具或任何由此產生的輸出作出任何陳述或保證。您承擔使用任何此類工具或輸出的**所有風險**；此類工具均按**「原樣」**和**「可用」**的基礎提供。此類風險可能包括但不限於智慧財產權侵權、網路漏洞或攻擊、偏見、不準確、錯誤、缺陷、病毒、停機、財產損失或損害和/或人身傷害。您對自己使用任何此類工具或輸出負全部責任（包括但不限於其合法性、適當性和結果）。
