...
import type { SkillMetadata } from "@kit-pilot/types"
...
const mockSkills: SkillMetadata[] = [
	{
		...
		path: "/workspace/.kitpilot/skills/project-skill/SKILL.md",
		source: "project",
	},
	{
		name: "project-mode-skill",
		description: "A project mode-specific skill",
		path: "/workspace/.kitpilot/skills/project-mode-skill/SKILL.md",
		source: "project",
		modeSlugs: ["architect"],
	},
	{
		...
		path: "/home/.kitpilot/skills/global-skill/SKILL.md",
		source: "global",
	},
]
