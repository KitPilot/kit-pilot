...
describe("ContextManagementSettings", () => {
	...
	it("renders other context management settings", () => {
		...
		expect(screen.getByTestId("show-kitpilotignored-files-checkbox")).toBeInTheDocument()
	...
	it("handles undefined optional props gracefully", () => {
		const propsWithUndefined = {
			...defaultProps,
			showKitPilotIgnoredFiles: undefined,
		}
	...
	describe("Accessibility", () => {
		it("has proper labels and descriptions", () => {
			...
			expect(screen.getByText("settings:contextManagement.kitpilotignore.label")).toBeInTheDocument()
			...
			expect(screen.getByText("settings:contextManagement.kitpilotignore.description")).toBeInTheDocument()
		})
