...
import { ModeConfig, GroupEntry, PromptComponent, ToolGroup, modeConfigSchema } from "@kit-pilot/types"
...
import { TOOL_GROUPS } from "@kitpilot/tools"
								...
								span: (
									<span
										...
										onClick={() => {
											...
											vscode.postMessage({
												type: "openFile",
												text: `./.kitpilot/rules-${currentMode.slug}/rules.md`,
												values: {
													create: true,
													content: "",
												},
